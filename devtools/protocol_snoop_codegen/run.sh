...
## This script updates code generated by mavkit-snoop in the proto_alpha folder.
...
./mavkit-snoop generate code for solutions src/proto_alpha/lib_protocol/gas_parameters.json --split-to "$TEMP_DIR" --fixed-point ./devtools/protocol_snoop_codegen/fixed_point_config.json
