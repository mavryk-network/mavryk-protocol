...
The coin flip contract :src:`<src/proto_alpha/lib_protocol/contracts/timelock_flip.mv>` gives an example of using time-lock. Beware this contract is for educational purpose only and is not secure.
