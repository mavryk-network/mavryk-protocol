...
A node in the Mavryk network provides different configuration possibilities:
...
- specify the Mavryk network to connect to, which can be the Mainnet or different test networks.
