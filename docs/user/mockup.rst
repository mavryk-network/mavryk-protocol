...
typecheck scripts. Let's typecheck for example the script :src:`tests_python/contracts/mini_scenarios/hardlimit.tz`:

.. code-block:: shell-session

    $ octez-client --mode mockup typecheck script tests_python/contracts/mini_scenarios/hardlimit.tz
...
.. code-block:: shell-session
  ...
  $ octez-client --mode mockup run script tests_python/contracts/attic/id.tz on storage '"hello"' and input '"world"'
