...
For a more general presentation of token standards such as FA1.2 from a Mavryk developer perspective, using higher-level smart contract languages, see Token standards in Mavryk.
