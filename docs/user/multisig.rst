...
The :src:`generic multisig contract<tests_python/contracts/mini_scenarios/generic_multisig.tz>` is
...
:src:`a legacy version<tests_python/contracts/mini_scenarios/legacy_multisig.tz>` of the multisig contract which has the following
limitations:
