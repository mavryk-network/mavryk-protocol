...
<tezos-protocol-001-PtAtLasL/Tezos_raw_protocol_001_PtAtLasL/Operation_repr/index.html>`.
...
Each kind of operation belongs to exactly one validation pass, except for the :ref:`failing_noop` which belongs to no validation pass and therefore cannot be :ref:`applied<operation_validity_atlas>`.
...
Tezos fundraiser to make their :ref:`accounts <def_account_atlas>` operational.
