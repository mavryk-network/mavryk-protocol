...
<delegating_coins>`. Therefore, in Tezos, it is the :ref:`delegates<def_delegate_atlas>`
...
On test-network only, if the :ref:`adaptive issuance <adaptive_issuance_atlas>`
