...
- Its state is given by the :ref:`context<def_context_boreas>`, the internal
...
modes<validation_modes_boreas>`. For example, these modes enable the
...
.. _protocol_classification_boreas:
...
.. _block_validation_overview_boreas:
...
candidate block declares consistent :ref:`level<def_level_boreas>`,
:ref:`round<def_round_boreas>`, and timestamp values; that it carries a valid
...
:ref:`operation_validity_boreas` further below, the whole block is
...
constitute a sufficiently large :ref:`quorum<quorum_boreas>`. That is,
...
block (see :ref:`partial_application_boreas` above). This feature
...
.. _manager_operations_validity_boreas:
...
:ref:`Manager operation<manager_operations_boreas>` are a class of
...
A :ref:`batch<manager_operations_batches_boreas>` of manager operations
...
.. _manager_operations_application_boreas:
