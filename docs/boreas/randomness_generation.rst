...
by the adaptive issuance coefficient <adaptive_issuance_boreas>`, is given for
...
<adaptive_issuance_boreas>`, is given for the first correct VDF revelation,
subsequent VDF revelation operations being discarded.

.. _rg_constants_boreas:
