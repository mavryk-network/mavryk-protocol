...
Furthermore, a `ticket <https://protocol.mavryk.org/michelson-reference/#type-ticket>`__ cannot be duplicated
with the `DUP <https://protocol.mavryk.org/michelson-reference/#instr-DUP>`__
or the `DUP n <https://protocol.mavryk.org/michelson-reference/#instr-DUPN>`__ instructions.
...
`instruction <https://protocol.mavryk.org/michelson-reference/#instr-TICKET>`__ with some ticket amount,
...
Smart contracts may split tickets by invoking the `SPLIT_TICKET <https://protocol.mavryk.org/michelson-reference/#instr-SLIT_TICKET>`__ instruction.
...
Smart contracts can join tickets via the `JOIN_TICKETS <https://protocol.mavryk.org/michelson-reference/#instr-JOIN_TICKETS>`__ instruction.
...
- *Smart contract to implicit account*: Smart contracts can transfer a ticket to implicit accounts
  via `TRANSFER_TOKENS <https://protocol.mavryk.org/michelson-reference/#instr-TRANSFER_TOKENS>`__.
