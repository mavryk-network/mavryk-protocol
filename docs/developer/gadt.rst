...
GADTs are a recent extension of OCaml, which is widely used in the Mavkit
...
some of the use cases of GADTs in Mavkit codebase and explains what role do they
play in the design.
...
One of the most important use cases for GADTs in Mavkit is ensuring type safety
