...
* the Rust dependencies are located in the GitLab repository `tezos-rust-libs <https://gitlab.com/mavryk-network/tezos-protocol-rust-libs>`_ and the instructions are listed there.
