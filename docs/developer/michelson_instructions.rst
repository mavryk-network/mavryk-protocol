...
- Updating the `Michelson reference website <https://protocol.mavryk.org/michelson-reference/>`__, by modifying the associated `repository <https://gitlab.com/tezos/michelson-reference>`__.
