...
Once your transaction is included in a block, you can retrieve it on `Nexus <https://nexus.mavryk.org>`__, which list the whole history of the different Mavryk networks (mainnet or test networks).
