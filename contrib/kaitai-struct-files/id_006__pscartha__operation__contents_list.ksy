...
types:
  ...
  double_baking_evidence__bh2:
    ...
    - id: size_of_bh2
      ...
      valid:
        max: 1073741823
    - id: bh2
      type: double_baking_evidence__id_006__pscartha__block_header__alpha__full_header
      size: size_of_bh2
  double_baking_evidence__bh1:
    ...
    - id: bh1
      type: double_baking_evidence__id_006__pscartha__block_header__alpha__full_header
      size: size_of_bh1
  double_baking_evidence__id_006__pscartha__block_header__alpha__full_header:
    seq:
    ...
    - id: double_baking_evidence__id_006__pscartha__block_header__alpha__signed_contents
      type: double_baking_evidence__id_006__pscartha__block_header__alpha__signed_contents
  double_baking_evidence__id_006__pscartha__block_header__alpha__signed_contents:
    seq:
    - id: double_baking_evidence__id_006__pscartha__block_header__alpha__unsigned_contents
      type: double_baking_evidence__id_006__pscartha__block_header__alpha__unsigned_contents
    - id: signature
      size: 64
  double_baking_evidence__id_006__pscartha__block_header__alpha__unsigned_contents:
    seq:
    - id: priority
      type: u2
  ...
  double_endorsement_evidence__op2:
    ...
    - id: size_of_op2
      ...
      valid:
        max: 1073741823
    - id: op2
      type: double_endorsement_evidence__id_006__pscartha__inlined__endorsement
      size: size_of_op2
  double_endorsement_evidence__op1:
    ...
    - id: op1
      type: double_endorsement_evidence__id_006__pscartha__inlined__endorsement
      size: size_of_op1
  double_endorsement_evidence__id_006__pscartha__inlined__endorsement:
    seq:
    - id: operation__shell_header
      size: 32
      doc: An operation's shell header.
    - id: operations
      type: double_endorsement_evidence__id_006__pscartha__inlined__endorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  double_endorsement_evidence__id_006__pscartha__inlined__endorsement__contents:
    seq:
