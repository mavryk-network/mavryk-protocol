...
types:
  id_011__pthangz2__operation_metadata__alpha__balance_updates:
    seq:
    - id: size_of_id_011__pthangz2__operation_metadata__alpha__balance_updates
      type: u4
      valid:
        max: 1073741823
    - id: id_011__pthangz2__operation_metadata__alpha__balance_updates
      ...
      size: size_of_id_011__pthangz2__operation_metadata__alpha__balance_updates
      repeat: eos
  ...
  id_011__pthangz2__operation_metadata__alpha__balance:
    ...
    - id: contract__id_011__pthangz2__operation_metadata__alpha__balance
      type: contract__id_011__pthangz2__contract_id
  ...
  fees__id_011__pthangz2__operation_metadata__alpha__balance:
    seq:
    - id: delegate
  ...
  rewards__public_key_hash:
    ...
    - id: rewards__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  contract__id_011__pthangz2__contract_id:
    seq:
