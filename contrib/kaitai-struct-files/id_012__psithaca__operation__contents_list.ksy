...
types:
  ...
  register_global_constant__id_012__psithaca__operation__alpha__contents:
    seq:
    - id: source
  ...
  origination__id_012__psithaca__operation__alpha__contents:
    ...
    - id: delegate
      ...
      doc: A Ed25519, Secp256k1, or P256 public key hash
    - id: script
      type: origination__id_012__psithaca__scripted__contracts
  origination__id_012__psithaca__scripted__contracts:
    seq:
  ...
  transaction__id_012__psithaca__operation__alpha__contents:
    ...
    - id: amount
      type: n
    - id: destination
      type: transaction__id_012__psithaca__contract_id
      doc: ! >-
  ...
  transaction__parameters:
    seq:
    - id: entrypoint
      type: transaction__id_012__psithaca__entrypoint
  ...
  transaction__id_012__psithaca__entrypoint:
    ...
    - id: transaction__named__id_012__psithaca__entrypoint
      type: transaction__named__id_012__psithaca__entrypoint
  ...
  transaction__named__id_012__psithaca__entrypoint:
    ...
    - id: named
      ...
      valid:
        max: 31
  transaction__id_012__psithaca__contract_id:
    seq:
  ...
  transaction__originated__id_012__psithaca__contract_id:
    seq:
    - id: contract_hash
      size: 20
  ...
  activate_account__id_012__psithaca__operation__alpha__contents:
    ...
    - id: secret
      size: 20
  double_baking_evidence__id_012__psithaca__operation__alpha__contents:
    seq:
  ...
  double_baking_evidence__id_012__psithaca__block_header__alpha__full_header:
    ...
    - id: double_baking_evidence__id_012__psithaca__block_header__alpha__signed_contents
      type: double_baking_evidence__id_012__psithaca__block_header__alpha__signed_contents
  double_baking_evidence__id_012__psithaca__block_header__alpha__signed_contents:
    seq:
    - id: double_baking_evidence__id_012__psithaca__block_header__alpha__unsigned_contents
      type: double_baking_evidence__id_012__psithaca__block_header__alpha__unsigned_contents
    - id: signature
      size: 64
  double_baking_evidence__id_012__psithaca__block_header__alpha__unsigned_contents:
    seq:
    - id: payload_hash
      size: 32
    - id: payload_round
  ...
  double_preendorsement_evidence__id_012__psithaca__inlined__preendorsement:
    ...
    - id: operations
      type: double_preendorsement_evidence__id_012__psithaca__inlined__preendorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  double_preendorsement_evidence__id_012__psithaca__inlined__preendorsement__contents:
    seq:
    - id: id_012__psithaca__inlined__preendorsement__contents_tag
      type: u1
      enum: id_012__psithaca__inlined__preendorsement__contents_tag
    - id: double_preendorsement_evidence__preendorsement__id_012__psithaca__inlined__preendorsement__contents
      type: double_preendorsement_evidence__preendorsement__id_012__psithaca__inlined__preendorsement__contents
  ...
  double_preendorsement_evidence__preendorsement__id_012__psithaca__inlined__preendorsement__contents:
    seq:
    - id: slot
      type: u2
    - id: level
    ...
    - id: block_payload_hash
      size: 32
  double_endorsement_evidence__id_012__psithaca__operation__alpha__contents:
    seq:
  ...
  double_endorsement_evidence__id_012__psithaca__inlined__endorsement:
    ...
    - id: operation__shell_header
      ...
      doc: An operation's shell header.
    - id: operations
      type: double_endorsement_evidence__id_012__psithaca__inlined__endorsement_mempool__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
      size: 64
      if: (signature_tag == bool::true)
  double_endorsement_evidence__id_012__psithaca__inlined__endorsement_mempool__contents:
    seq:
    ...
    - id: double_endorsement_evidence__endorsement__id_012__psithaca__inlined__endorsement_mempool__contents
      type: double_endorsement_evidence__endorsement__id_012__psithaca__inlined__endorsement_mempool__contents
  ...
  double_endorsement_evidence__endorsement__id_012__psithaca__inlined__endorsement_mempool__contents:
    seq:
    - id: slot
      type: u2
    - id: level
  ...
  seed_nonce_revelation__id_012__psithaca__operation__alpha__contents:
    ...
    - id: nonce
      size: 32
  preendorsement__id_012__psithaca__operation__alpha__contents:
    seq:
    - id: slot
      type: u2
    - id: level
    ...
    - id: block_payload_hash
      size: 32
  endorsement__id_012__psithaca__operation__alpha__contents:
    seq:
    - id: slot
      type: u2
    - id: level
