...
types:
  ...
  register_global_constant__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
  ...
  delegation__public_key_hash:
    ...
    - id: delegation__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  origination__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
    ...
    - id: delegate
      ...
      doc: A Ed25519, Secp256k1, or P256 public key hash
    - id: script
      type: origination__id_011__pthangz2__scripted__contracts
  origination__id_011__pthangz2__scripted__contracts:
    seq:
  ...
  origination__public_key_hash:
    ...
    - id: origination__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  transaction__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
    ...
    - id: amount
      type: n
    - id: destination
      type: transaction__id_011__pthangz2__contract_id
      doc: ! >-
  ...
  transaction__parameters:
    seq:
    - id: entrypoint
      type: transaction__id_011__pthangz2__entrypoint
  ...
  transaction__named__id_011__pthangz2__entrypoint:
    ...
    - id: named
      ...
      valid:
        max: 31
  transaction__id_011__pthangz2__contract_id:
    seq:
  ...
  transaction__public_key_hash:
    ...
    - id: transaction__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  reveal__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
  ...
  reveal__public_key_hash:
    ...
    - id: reveal__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  ballot__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
  ...
  ballot__public_key_hash:
    ...
    - id: ballot__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  proposals__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: source
  ...
  proposals__public_key_hash:
    ...
    - id: proposals__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  activate_account__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: pkh
      size: 20
    - id: secret
      size: 20
  double_baking_evidence__id_011__pthangz2__operation__alpha__contents:
    seq:
  ...
  double_baking_evidence__bh2:
    ...
    - id: size_of_bh2
      ...
      valid:
        max: 1073741823
    - id: bh2
      type: double_baking_evidence__id_011__pthangz2__block_header__alpha__full_header
      size: size_of_bh2
  double_baking_evidence__bh1:
    ...
    - id: bh1
      type: double_baking_evidence__id_011__pthangz2__block_header__alpha__full_header
      size: size_of_bh1
  double_baking_evidence__id_011__pthangz2__block_header__alpha__full_header:
    seq:
    ...
    - id: double_baking_evidence__id_011__pthangz2__block_header__alpha__signed_contents
      type: double_baking_evidence__id_011__pthangz2__block_header__alpha__signed_contents
  double_baking_evidence__id_011__pthangz2__block_header__alpha__signed_contents:
    seq:
    - id: double_baking_evidence__id_011__pthangz2__block_header__alpha__unsigned_contents
      type: double_baking_evidence__id_011__pthangz2__block_header__alpha__unsigned_contents
    - id: signature
      size: 64
  double_baking_evidence__id_011__pthangz2__block_header__alpha__unsigned_contents:
    seq:
    - id: priority
      type: u2
  ...
  double_endorsement_evidence__id_011__pthangz2__operation__alpha__contents:
    seq:
  ...
  double_endorsement_evidence__op2:
    ...
    - id: size_of_op2
      ...
      valid:
        max: 1073741823
    - id: op2
      type: double_endorsement_evidence__id_011__pthangz2__inlined__endorsement
      size: size_of_op2
  double_endorsement_evidence__op1:
    ...
    - id: op1
      type: double_endorsement_evidence__id_011__pthangz2__inlined__endorsement
      size: size_of_op1
  double_endorsement_evidence__id_011__pthangz2__inlined__endorsement:
    seq:
    - id: operation__shell_header
      size: 32
      doc: An operation's shell header.
    - id: operations
      type: double_endorsement_evidence__id_011__pthangz2__inlined__endorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
  ...
  double_endorsement_evidence__id_011__pthangz2__inlined__endorsement__contents:
    seq:
    - id: id_011__pthangz2__inlined__endorsement__contents_tag
      type: u1
      enum: id_011__pthangz2__inlined__endorsement__contents_tag
    - id: double_endorsement_evidence__endorsement__id_011__pthangz2__inlined__endorsement__contents
      type: s4
      if: (id_011__pthangz2__inlined__endorsement__contents_tag == id_011__pthangz2__inlined__endorsement__contents_tag::endorsement)
  endorsement_with_slot__id_011__pthangz2__operation__alpha__contents:
    seq:
  ...
  endorsement_with_slot__endorsement:
    ...
    - id: size_of_endorsement
      ...
      valid:
        max: 1073741823
    - id: endorsement
      type: endorsement_with_slot__id_011__pthangz2__inlined__endorsement
      size: size_of_endorsement
  endorsement_with_slot__id_011__pthangz2__inlined__endorsement:
    seq:
    - id: operation__shell_header
      size: 32
      doc: An operation's shell header.
    - id: operations
      type: endorsement_with_slot__id_011__pthangz2__inlined__endorsement__contents
    - id: signature_tag
      type: u1
      enum: bool
    - id: signature
      size: 64
      if: (signature_tag == bool::true)
  endorsement_with_slot__id_011__pthangz2__inlined__endorsement__contents:
    seq:
    - id: id_011__pthangz2__inlined__endorsement__contents_tag
      type: u1
      enum: id_011__pthangz2__inlined__endorsement__contents_tag
    - id: endorsement_with_slot__endorsement__id_011__pthangz2__inlined__endorsement__contents
      type: s4
      if: (id_011__pthangz2__inlined__endorsement__contents_tag == id_011__pthangz2__inlined__endorsement__contents_tag::endorsement)
  seed_nonce_revelation__id_011__pthangz2__operation__alpha__contents:
    seq:
    - id: level
      type: s4
    - id: nonce
