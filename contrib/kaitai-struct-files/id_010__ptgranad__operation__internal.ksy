...
types:
  id_010__ptgranad__operation__alpha__internal_operation:
    ...
    - id: reveal__id_010__ptgranad__operation__alpha__internal_operation
    ...
    - id: transaction__id_010__ptgranad__operation__alpha__internal_operation
      type: transaction__id_010__ptgranad__operation__alpha__internal_operation
    ...
    - id: origination__id_010__ptgranad__operation__alpha__internal_operation
      type: origination__id_010__ptgranad__operation__alpha__internal_operation
    ...
    - id: delegation__id_010__ptgranad__operation__alpha__internal_operation
      type: delegation__id_010__ptgranad__operation__alpha__internal_operation
  ...
  delegation__id_010__ptgranad__operation__alpha__internal_operation:
    seq:
    - id: delegate_tag
      type: u1
      enum: bool
  ...
  origination__id_010__ptgranad__operation__alpha__internal_operation:
    seq:
    - id: balance
      type: n
    - id: delegate_tag
  ...
  origination__public_key_hash:
    ...
    - id: origination__p256__public_key_hash
      size: 20
      if: (public_key_hash_tag == public_key_hash_tag::p256)
  transaction__id_010__ptgranad__operation__alpha__internal_operation:
    seq:
    - id: amount
      type: n
    - id: destination
