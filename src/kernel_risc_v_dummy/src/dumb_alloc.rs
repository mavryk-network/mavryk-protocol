...
extern "C" {
    ...
    // of this name that incidates the start, not its value.
    static _sheap: u8;
}
...
/// Reads the offset value at the start of the hea.
...
unsafe impl GlobalAlloc for Allocator {
    unsafe fn alloc(&self, layout: core::alloc::Layout) -> *mut u8 {
        ...
        // Calculate the addess of the newly allocated area, and properly
        // align it.
