...
let build_rpc_directory node_version config =
  let dir = Mavryk_shell.Version_directory.rpc_directory node_version in
  let dir =
    Mavryk_shell.Config_directory.build_rpc_directory_for_rpc_process
      ...
      dir
  in
  Mavryk_rpc.Directory.register0 dir Node_services.S.config (fun () () ->
