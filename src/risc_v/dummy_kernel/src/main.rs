...
use mavryk_smart_rollup::core_unsafe::rollup_host::RollupHost;

#[inline]
fn main_wrapper() -> ! {
    #[cfg(target_arch = "riscv64")]
    use mavryk_smart_rollup::core_unsafe::riscv64_syscalls::exit;
...
mod bare_metal {
    ...
    pub fn panic_handler(info: &core::panic::PanicInfo) -> ! {
        mavryk_smart_rollup_panic_hook::panic_handler(info);
        exit(1)
    }
