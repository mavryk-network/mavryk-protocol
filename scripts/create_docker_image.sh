...
rust_toolchain_image="registry.gitlab.com/mavryk-network/mavryk-protocol/rust-toolchain"
...
print_help() {
  ...
  usage
  echo ""
  echo "Creates the Mavkit docker images." 1>&2
  echo ""
  print_parameters
}
...
docker build \
  ...
  --build-arg "MAVKIT_EXECUTABLES=${executables}" \
