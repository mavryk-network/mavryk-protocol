...
if [ "${CI_COMMIT_REF_NAME}" == "master" ] ; then
  echo git@gitlab.com:"${CI_PROJECT_NAMESPACE}"/"${CI_PROJECT_NAME}".gitlab.io gitlab.io ;
  git clone --depth 5 git@gitlab.com:"${CI_PROJECT_NAMESPACE}"/"${CI_PROJECT_NAME}".gitlab.io gitlab.io ;
