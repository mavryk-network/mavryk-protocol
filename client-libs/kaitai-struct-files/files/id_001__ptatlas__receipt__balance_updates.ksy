meta:
  id: id_001__ptatlas__receipt__balance_updates
  endian: be
doc: ! 'Encoding id: 001-PtAtLas.receipt.balance_updates'
types:
  commitments:
    seq:
    - id: committer
  ...
  deposits:
    seq:
    - id: staker
      type: id_001__ptatlas__frozen_staker
      doc: ! >-
  ...
  id_001__ptatlas__bond_id:
    ...
    - id: id_001__ptatlas__bond_id_tag
      type: u1
      enum: id_001__ptatlas__bond_id_tag
    - id: smart_rollup_bond_id
      size: 20
      if: (id_001__ptatlas__bond_id_tag == id_001__ptatlas__bond_id_tag::smart_rollup_bond_id)
  ...
  id_001__ptatlas__frozen_staker:
    seq:
    - id: id_001__ptatlas__frozen_staker_tag
      type: u1
      enum: id_001__ptatlas__frozen_staker_tag
    - id: single
      type: single
      if: (id_001__ptatlas__frozen_staker_tag == id_001__ptatlas__frozen_staker_tag::single)
    - id: shared
      type: public_key_hash
      if: (id_001__ptatlas__frozen_staker_tag == id_001__ptatlas__frozen_staker_tag::shared)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: baker
      type: public_key_hash
      if: (id_001__ptatlas__frozen_staker_tag == id_001__ptatlas__frozen_staker_tag::baker)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
  id_001__ptatlas__operation_metadata__alpha__balance_and_update:
    seq:
    - id: id_001__ptatlas__operation_metadata__alpha__balance_and_update_tag
      type: u1
  ...
  id_001__ptatlas__operation_metadata__alpha__balance_updates:
    ...
    - id: id_001__ptatlas__operation_metadata__alpha__balance_updates_entries
      type: id_001__ptatlas__operation_metadata__alpha__balance_updates_entries
      repeat: eos
  id_001__ptatlas__operation_metadata__alpha__balance_updates_0:
    ...
    - id: id_001__ptatlas__operation_metadata__alpha__balance_updates
      type: id_001__ptatlas__operation_metadata__alpha__balance_updates
      size: len_id_001__ptatlas__operation_metadata__alpha__balance_updates
  id_001__ptatlas__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_001__ptatlas__operation_metadata__alpha__balance_and_update
      type: id_001__ptatlas__operation_metadata__alpha__balance_and_update
    - id: id_001__ptatlas__operation_metadata__alpha__update_origin
      type: id_001__ptatlas__operation_metadata__alpha__update_origin
  ...
  id_001__ptatlas__operation_metadata__alpha__update_origin:
    ...
    - id: id_001__ptatlas__operation_metadata__alpha__update_origin_tag
      type: u1
      enum: id_001__ptatlas__operation_metadata__alpha__update_origin_tag
    - id: delayed_operation
      size: 32
      if: (id_001__ptatlas__operation_metadata__alpha__update_origin_tag == id_001__ptatlas__operation_metadata__alpha__update_origin_tag::delayed_operation)
  id_001__ptatlas__staker:
    seq:
    - id: id_001__ptatlas__staker_tag
      type: u1
      enum: id_001__ptatlas__staker_tag
    - id: single
      type: single
      if: (id_001__ptatlas__staker_tag == id_001__ptatlas__staker_tag::single)
    - id: shared
      type: public_key_hash
      if: (id_001__ptatlas__staker_tag == id_001__ptatlas__staker_tag::shared)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
  ...
  staking_delegate_denominator:
    ...
    - id: delegate
      type: public_key_hash
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: id_001__ptatlas__operation_metadata__alpha__staking_abstract_quantity
      type: id_001__ptatlas__operation_metadata__alpha__staking_abstract_quantity
...
enums:
  bool:
    0: false
    255: true
  id_001__ptatlas__bond_id_tag:
    1: smart_rollup_bond_id
  id_001__ptatlas__contract_id_tag:
    0: implicit
    1: originated
  id_001__ptatlas__frozen_staker_tag:
    0: single
    1: shared
    2: baker
  id_001__ptatlas__operation_metadata__alpha__balance_and_update_tag:
    0: contract
    2: block_fees
    4: deposits
  ...
  id_001__ptatlas__operation_metadata__alpha__update_origin_tag:
    0: block_application
    1: protocol_migration
    2: subsidy
    3: simulation
    4: delayed_operation
  id_001__ptatlas__staker_tag:
    0: single
    1: shared
  public_key_hash_tag:
    0: ed25519
...
seq:
- id: id_001__ptatlas__operation_metadata__alpha__balance_updates
  type: id_001__ptatlas__operation_metadata__alpha__balance_updates_0
