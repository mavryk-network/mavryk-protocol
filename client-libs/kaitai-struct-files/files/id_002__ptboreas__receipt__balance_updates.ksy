meta:
  id: id_002__ptboreas__receipt__balance_updates
  endian: be
doc: ! 'Encoding id: 002-PtBoreas.receipt.balance_updates'
types:
  commitments:
    seq:
    - id: committer
  ...
  deposits:
    seq:
    - id: staker
      type: id_002__ptboreas__frozen_staker
      doc: ! >-
  ...
  id_002__ptboreas__bond_id:
    ...
    - id: id_002__ptboreas__bond_id_tag
      type: u1
      enum: id_002__ptboreas__bond_id_tag
    - id: smart_rollup_bond_id
      size: 20
      if: (id_002__ptboreas__bond_id_tag == id_002__ptboreas__bond_id_tag::smart_rollup_bond_id)
  ...
  id_002__ptboreas__frozen_staker:
    seq:
    - id: id_002__ptboreas__frozen_staker_tag
      type: u1
      enum: id_002__ptboreas__frozen_staker_tag
    - id: single
      type: single
      if: (id_002__ptboreas__frozen_staker_tag == id_002__ptboreas__frozen_staker_tag::single)
    - id: shared
      type: public_key_hash
      if: (id_002__ptboreas__frozen_staker_tag == id_002__ptboreas__frozen_staker_tag::shared)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: baker
      type: public_key_hash
      if: (id_002__ptboreas__frozen_staker_tag == id_002__ptboreas__frozen_staker_tag::baker)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: baker_edge
      type: public_key_hash
      if: (id_002__ptboreas__frozen_staker_tag == id_002__ptboreas__frozen_staker_tag::baker_edge)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
  id_002__ptboreas__operation_metadata__alpha__balance_and_update:
    seq:
    - id: id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag
      type: u1
      enum: id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag
    - id: contract
      type: contract
    ...
    - id: unstaked_deposits
      ...
      if: (id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag ==
        id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag::unstaked_deposits)
    - id: staking_delegator_numerator
      type: staking_delegator_numerator
      if: (id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag ==
        id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag::staking_delegator_numerator)
    - id: staking_delegate_denominator
      type: staking_delegate_denominator
      if: (id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag ==
        id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag::staking_delegate_denominator)
  id_002__ptboreas__operation_metadata__alpha__balance_updates:
    seq:
    - id: id_002__ptboreas__operation_metadata__alpha__balance_updates_entries
      type: id_002__ptboreas__operation_metadata__alpha__balance_updates_entries
      repeat: eos
  id_002__ptboreas__operation_metadata__alpha__balance_updates_0:
    seq:
    - id: len_id_002__ptboreas__operation_metadata__alpha__balance_updates
      type: u4be
      valid:
        max: 1073741823
    - id: id_002__ptboreas__operation_metadata__alpha__balance_updates
      type: id_002__ptboreas__operation_metadata__alpha__balance_updates
      size: len_id_002__ptboreas__operation_metadata__alpha__balance_updates
  id_002__ptboreas__operation_metadata__alpha__balance_updates_entries:
    seq:
    - id: id_002__ptboreas__operation_metadata__alpha__balance_and_update
  ...
  id_002__ptboreas__operation_metadata__alpha__mav_balance_update:
    ...
    - id: change
      type: s8be
  id_002__ptboreas__operation_metadata__alpha__update_origin:
    seq:
    - id: id_002__ptboreas__operation_metadata__alpha__update_origin_tag
      type: u1
      enum: id_002__ptboreas__operation_metadata__alpha__update_origin_tag
    - id: delayed_operation
      size: 32
      if: (id_002__ptboreas__operation_metadata__alpha__update_origin_tag == id_002__ptboreas__operation_metadata__alpha__update_origin_tag::delayed_operation)
  id_002__ptboreas__staker:
    seq:
    - id: id_002__ptboreas__staker_tag
      type: u1
      enum: id_002__ptboreas__staker_tag
    - id: single
      type: single
      if: (id_002__ptboreas__staker_tag == id_002__ptboreas__staker_tag::single)
    - id: shared
      type: public_key_hash
      if: (id_002__ptboreas__staker_tag == id_002__ptboreas__staker_tag::shared)
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
  ...
  staking_delegate_denominator:
    ...
    - id: delegate
      type: public_key_hash
      doc: A Ed25519, Secp256k1, P256, or BLS public key hash
    - id: id_002__ptboreas__operation_metadata__alpha__staking_abstract_quantity
      type: id_002__ptboreas__operation_metadata__alpha__staking_abstract_quantity
...
enums:
  bool:
    0: false
    255: true
  id_002__ptboreas__bond_id_tag:
    1: smart_rollup_bond_id
  id_002__ptboreas__contract_id_tag:
    0: implicit
    1: originated
  id_002__ptboreas__frozen_staker_tag:
    0: single
    1: shared
    2: baker
    3: baker_edge
  id_002__ptboreas__operation_metadata__alpha__balance_and_update_tag:
    0: contract
    2: block_fees
    4: deposits
  ...
  id_002__ptboreas__operation_metadata__alpha__update_origin_tag:
    0: block_application
    1: protocol_migration
    2: subsidy
    3: simulation
    4: delayed_operation
  id_002__ptboreas__staker_tag:
    0: single
    1: shared
  public_key_hash_tag:
    0: ed25519
...
seq:
- id: id_002__ptboreas__operation_metadata__alpha__balance_updates
  type: id_002__ptboreas__operation_metadata__alpha__balance_updates_0
