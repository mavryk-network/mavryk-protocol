...
rust_image=${rust_image:-"registry.gitlab.com/mavryk-network/mavryk-protocol/rust-toolchain"}
...
env_options:
- rust_image (default="registry.gitlab.com/mavryk-network/mavryk-protocol/rust-toolchain")
